      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="flex space-x-8 px-[150px]">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div>
              <span className="font-bold text-[18px]">Liên hệ mua hàng:</span>
              <div>
                <div className="flex items-center space-x-2">
                  <span>70-72 Tây Sơn, Đống Đa HN:</span>
                  <span className="font-medium text-[blue]">0964907954</span>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col space-y-4">
              <details className="rounded-lg" open>
                ...
                <div className="mt-3 text-sm leading-6 text-slate-600">
                  <p>
                    Mua Giày Adidas Superstar OG 'Vintage White' C77124 chính
                    hãng 100% có sẵn tại Jordan 1. Giao hàng miễn phí trong 1
                    ngày. Cam kết đền tiền X5 nếu phát hiện Fake. Đổi trả miễn
                    phí size. FREE vệ sinh giày trọn đời. MUA NGAY!
                  </p>
                </div>
              </details>
              <details className="rounded-lg" open>
